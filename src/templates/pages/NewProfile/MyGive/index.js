...
class MyGive extends Component {
    ...
    componentDidMount() {
        ...
        setTimeout(() => {
            const { viewReceiptInfo } = this.props;
            if (viewReceiptInfo.viewReceipt) {
                if (viewReceiptInfo.nonprofitId) {
                    this.setState({
                        tabIndex: 3,
                        nonprofitId: viewReceiptInfo.nonprofitId,
                        nonprofitName: viewReceiptInfo.nonprofitName
                    }, () => {
                        this.props.clearRecurringList();
                        this.getRecurring(viewReceiptInfo.nonprofitId);
                    })
                }
            }
        }, 500);
