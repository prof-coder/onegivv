...
class VolunteerUpdateModal extends Component {
	state = {
		step: 0,
		error: 0,
		startTime: null,
	...
	componentWillReceiveProps(nextprops) {
		if (nextprops.preloader.actionName === 'updateVolunteer' && nextprops.preloader.show === false) {
			this.setState({ step: 1 })
		}

		if (nextprops.request) {
			this.setState({ startTime: moment.unix(nextprops.request.startDate), endTime: moment.unix(nextprops.request.endDate) })
		}
	}
